...
function paginationResolver(baseQuery_1, queryParams_1, _a) {
    return __awaiter(this, arguments, void 0, function* (baseQuery, queryParams, { first, after, last, before }) {
        let query = baseQuery;
...
const resolvers = {
    RootQueryType: {
        ...
        poll: (parent_1, _a) => __awaiter(void 0, [parent_1, _a], void 0, function* (parent, { id }) {
        ...
        searchPolls: (parent_1, _a) => __awaiter(void 0, [parent_1, _a], void 0, function* (parent, { searchTerm }) {
            const rows = yield (0, db_utils_1.dbAll)('SELECT * FROM Polls WHERE title LIKE ?', [`%${searchTerm}%`]);
            return rows.map(row => (Object.assign(Object.assign({}, row), { id: toGlobalId('Poll', row.id) })));
        }),
        user: (parent_1, _a) => __awaiter(void 0, [parent_1, _a], void 0, function* (parent, { id }) {
    ...
    Mutation: {
        createPoll: (parent_1, _a) => __awaiter(void 0, [parent_1, _a], void 0, function* (parent, { title, options, userId }) {
            ...
            yield (0, db_utils_1.dbRun)('INSERT INTO PollPermissions (pollId, permission_type, target_type, target_id) VALUES (?, ?, ?, ?)', [pollId, graphql_1.PermissionType.View, graphql_1.TargetType.Public, null]);
            console.log('Inserted VIEW permission');
            yield (0, db_utils_1.dbRun)('INSERT INTO PollPermissions (pollId, permission_type, target_type, target_id) VALUES (?, ?, ?, ?)', [pollId, graphql_1.PermissionType.Vote, graphql_1.TargetType.Public, null]);
        ...
        submitVote: (parent_1, _a) => __awaiter(void 0, [parent_1, _a], void 0, function* (parent, { pollId, userId, ratings }) {
        ...
        editPoll: (parent_1, _a) => __awaiter(void 0, [parent_1, _a], void 0, function* (parent, { pollId, userId, title, options }) {
            const { id: pollIdStr } = fromGlobalId(pollId);
            const parsedPollId = parseInt(pollIdStr, 10);
            const { id: userIdStr } = fromGlobalId(userId);
            const parsedUserId = parseInt(userIdStr, 10);
        ...
        signup: (parent_1, _a) => __awaiter(void 0, [parent_1, _a], void 0, function* (parent, { username, email, password }) {
        ...
        login: (parent_1, _a) => __awaiter(void 0, [parent_1, _a], void 0, function* (parent, { username, password }) {
    ...
    User: {
        ...
        polls: (parent_1, _a) => __awaiter(void 0, [parent_1, _a], void 0, function* (parent, { permission }) {
