...
import { VotePageMutation as VoteSubmitVoteMutationType } from './__generated__/VotePageMutation.graphql';
import { Vote_poll$key } from '@/components/Poll/Vote/__generated__/Vote_poll.graphql';
import { Draggable, Droppable } from '@/components/ui/dnd';
import { Badge } from '@/components/ui/badge';
import { RecordSourceSelectorProxy } from 'relay-runtime';
import { PollOption as Option } from '@/../shared/generated-types';

const VotePageMutation = graphql`
  mutation VotePageMutation($pollId: ID!, $userId: ID!, $ratings: [VoteRatingInput!]!) {
...
const Vote_poll = graphql`
  fragment VotePage_poll on Poll {
    id
    options {
      id
      optionText
...
const VotePage = ({ userId, poll: pollProp }: { userId: string, poll: Vote_poll$key }) => {
    ...
    const [commitMutation] = useMutation<VoteSubmitVoteMutationType>(VotePageMutation);
