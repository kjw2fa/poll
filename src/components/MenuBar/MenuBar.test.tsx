...
describe('MenuBar component', () => {
  ...
  test('applies active class to current page link', () => {
    ...
    expect(screen.getByRole('link', { name: /Home/i })).not.toHaveAttribute('data-active');
    expect(screen.getByRole('link', { name: /Create Poll/i })).toHaveAttribute('data-active');
    expect(screen.getByRole('link', { name: /View Polls/i })).not.toHaveAttribute('data-active');
    expect(screen.getByRole('link', { name: /My Polls/i })).not.toHaveAttribute('data-active');
  });
});
